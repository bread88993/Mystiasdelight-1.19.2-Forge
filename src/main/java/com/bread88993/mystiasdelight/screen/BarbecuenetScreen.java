...
public class BarbecuenetScreen extends AbstractContainerScreen<BarbecuenetMenu>{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Mystiasdelight.MOD_ID,"textures/gui/barbecuenet_gui.png");
    private static final Rectangle HEAT_ICON = new Rectangle(47, 55, 17, 15);
    private static final Rectangle PROGRESS_ARROW = new Rectangle(89, 25, 0, 17);



    public BarbecuenetScreen(BarbecuenetMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
