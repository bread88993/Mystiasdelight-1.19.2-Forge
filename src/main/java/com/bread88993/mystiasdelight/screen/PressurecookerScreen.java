...
public class PressurecookerScreen extends AbstractContainerScreen<PressurecookerMenu>{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Mystiasdelight.MOD_ID,"textures/gui/pressurecooker_gui.png");
    private static final Rectangle HEAT_ICON = new Rectangle(47, 55, 17, 15);
    private static final Rectangle PROGRESS_ARROW = new Rectangle(89, 25, 0, 17);



    public PressurecookerScreen(PressurecookerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
