...
public class WokMenu extends AbstractContainerMenu {
    ...
    public WokMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public WokMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.WOK_MENU.get(), pContainerId);
        checkContainerSize(inv,8);
        blockEntity = ((WokBlockEntity) entity);
