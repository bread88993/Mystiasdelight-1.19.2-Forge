...
import com.bread88993.mystiasdelight.screen.slot.ModResultSlot;
...
public class BarbecuenetMenu extends AbstractContainerMenu {
    private final BarbecuenetBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public BarbecuenetMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public BarbecuenetMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.BARBECUENET_MENU.get(), pContainerId);
        checkContainerSize(inv,8);
        blockEntity = ((BarbecuenetBlockEntity) entity);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 6, 92, 45));
            this.addSlot(new ModResultSlot(handler, 7, 124, 27));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.BARBECUENET.get());
    }
