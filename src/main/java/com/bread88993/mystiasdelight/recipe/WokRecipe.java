...
public class WokRecipe implements Recipe<RecipeWrapper> {
    ...
    public WokRecipe(ResourceLocation id, String group, ItemStack output,
    ...
    public static class Type implements RecipeType<WokRecipe>{
        private Type(){}
        public static final Type FRY = new Type();
        public static final String ID = "frying";
    }

    public static class Serializer implements RecipeSerializer<WokRecipe> {
        public static final Serializer FRY = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(Mystiasdelight.MOD_ID,"frying");
...
//
        ...
        public WokRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputItemsIn.isEmpty()) {
            ...
            } else if (inputItemsIn.size() > WokRecipe.INPUT_SLOTS) {
                throw new JsonParseException("Too many ingredients for cooking recipe! The max is " + WokRecipe.INPUT_SLOTS);
            } else {
                ...
                return new WokRecipe(recipeId,groupIn,outputIn, inputItemsIn,cookTimeIn);
            }
        }
