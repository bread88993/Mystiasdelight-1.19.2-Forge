...
public class PressurecookerRecipe implements Recipe<RecipeWrapper> {
    ...
    public PressurecookerRecipe(ResourceLocation id, String group, ItemStack output,
    ...
    public static class Type implements RecipeType<PressurecookerRecipe>{
        private Type(){}
        public static final Type PRESS = new Type();
        public static final String ID = "pressure";
    }

    public static class Serializer implements RecipeSerializer<PressurecookerRecipe> {
        public static final Serializer PRESS = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(Mystiasdelight.MOD_ID,"pressure");
...
//
        ...
        @Override
        public PressurecookerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputItemsIn.isEmpty()) {
            ...
            } else if (inputItemsIn.size() > PressurecookerRecipe.INPUT_SLOTS) {
                throw new JsonParseException("Too many ingredients for cooking recipe! The max is " + PressurecookerRecipe.INPUT_SLOTS);
            } else {
                ...
                return new PressurecookerRecipe(recipeId,groupIn,outputIn, inputItemsIn,cookTimeIn);
            }
        }
        ...
        @Nullable
        @Override
        public PressurecookerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, PressurecookerRecipe recipe) {
