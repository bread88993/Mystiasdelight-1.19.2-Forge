...
public class SteamerRecipe implements Recipe<RecipeWrapper> {
    ...
    public SteamerRecipe(ResourceLocation id, String group, ItemStack output,
    ...
    public static class Type implements RecipeType<SteamerRecipe>{
        private Type(){}
        public static final Type STEAM = new Type();
        public static final String ID = "steaming";
    }

    public static class Serializer implements RecipeSerializer<SteamerRecipe> {
        public static final Serializer STEAM = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(Mystiasdelight.MOD_ID,"steaming");
...
//
        ...
        public SteamerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputItemsIn.isEmpty()) {
            ...
            } else if (inputItemsIn.size() > SteamerRecipe.INPUT_SLOTS) {
                throw new JsonParseException("Too many ingredients for cooking recipe! The max is " + SteamerRecipe.INPUT_SLOTS);
            } else {
                ...
                return new SteamerRecipe(recipeId,groupIn,outputIn, inputItemsIn,cookTimeIn);
            }
        }
